...
def home():
    ...
    <body style="font-family: Arial; background:#111; color:#0f0; padding:20px;">
        ...
        <form action="/ghost" method="get">
            Team Code: <input name="teamcode" placeholder="Enter Team Code"><br><br>
            Ghost Name: <input name="ghost_name" placeholder="MAHIR"><br><br>
            <button type="submit">Send Ghost</button>
        </form>

        <br>

        <a href="/ghost_all?teamcode=123456&ghost_names={A}{B}{C}">
            🔥 Run Ghost All Clients
        </a>
        ...
        <p>
            <a href="/list_clients">📋 List Clients</a>
        </p>

        <p>
            <a href="/execute_command_all?command=/XRRR=123456">⚡ Execute Command All</a>
        </p>
